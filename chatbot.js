...
var multimemes = ["<img src='http://images.mentalfloss.com/sites/default/files/styles/article_640x430/public/catffaceheader.jpg' height='42' width='42'>"];
...
//function chatBotWords(){
  ...
  //for (i = 0; i < questionArray.length; i++) {
    // questionArray = {
      //"hi" : "yo"
    //}
    //$('#chat-area').prepend("You: " + questionArray + "</br>");
//}
//}
